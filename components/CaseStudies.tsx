...
const caseStudiesData = [
  ...
  {
    href: "https://t.me/web3hackathons",
    imageSrc: "/assets/images/communities/web3hackathons.jpg",
    imageAlt: "Web3 Hackathons",
    title: "Web3 Hackathons",
    description: "Web3 hackathons, events, and news",
    hashtag: "#web3hackathons",
    icon: <Podcast className="w-4 h-4 text-gray-400" />,
  },
  {
    href: "https://t.me/webfsn",
    imageSrc: "/assets/images/communities/webfsn.jpg",
    imageAlt: "Web3 Hackathons",
    title: "African Crypto",
    description: "Everything crypto x Africa curated by WebFusion",
    hashtag: "#africa",
    icon: <Podcast className="w-4 h-4 text-gray-400" />,
  },
  {
    href: "https://t.me/afrobeats_party",
    imageSrc: "/assets/images/communities/afrobeats.jpg",
    imageAlt: "Afrobeats News",
    title: "Afrobeats News",
    description: "All Afrobeats news, music & updates by AfrobeatsDAO",
    hashtag: "#afrobeats",
    icon: <Podcast className="w-4 h-4 text-gray-400" />,
  },
  {
